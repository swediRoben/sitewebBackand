...
import com.site.siteweb.service.IndexMenuJsonService;
...
public class IndexJsonController {
     @Autowired
    private IndexMenuJsonService service;
        ...
        public ResponseEntity<Object> add(@RequestHeader(name = "Accept-Language", required = false) String localeString,
                @RequestParam("file") MultipartFile[] file,@RequestBody Index dto) throws IOException { 
        ...
        @PutMapping("/{id}")
        public ResponseEntity<Object> upDate(@PathVariable("id") Integer id,@RequestHeader(name = "Accept-Language", required = false) String localeString,@RequestParam("file") MultipartFile[] file,@RequestBody Index dto) throws IOException { 
